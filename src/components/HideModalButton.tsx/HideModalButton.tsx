...
import "./HideModalButton.css"
import { useGlobalSettings } from "../../hooks/useGlobalSettingsHook"


const HideModalButton = () =>{
    const {isDarkMode, toggleModalShow} = useGlobalSettings()

    return(
        <>
            <button
            className={`hide-modal-button ${isDarkMode ? '' : 'light'}`}
            onClick={()=> toggleModalShow()}
            >

            <svg width="24px" height="24px" strokeWidth="1.5" viewBox="0 0 24 24" 
            fill="none" xmlns="http://www.w3.org/2000/svg" color="#000000">
            <path d="M12 22V13M12 13L15.5 16.5M12 13L8.5 16.5" stroke="#000000" 
